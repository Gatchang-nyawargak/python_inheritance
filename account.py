class Account:
    def __init__(self, number, pin, owner=None):
        ...
        self.__balance = 0
        self.overdraft_limit = 0  # Default overdraft limit is 0
        self.is_frozen = False
        self.minimum_balance = 0  # Default minimum balance is 0
        self.transactions: list[float] = []
        self.history: list[str] = []  # Transaction history
...
# Example usage
account = Account(12137464, 7744, "Grace")
account.deposit(5986)
print(account.check_balance(48757))
